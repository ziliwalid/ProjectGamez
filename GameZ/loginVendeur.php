...
<div class="login-form">
    <form action="loginVendeur.php" method="POST">
        <h3 class="text-center">Connectez-vous a votre compte Vendeur.</h3>       
        ...
        <div class="form-group">Don't have an account <a href="signUpVendeur.php">Sign up here.</a>
        </div>
  ...
  if(!empty($_POST['connection']))
    {
       ...
       $r=client::GetVendeur($mail,$password);
       if($r==0)
       {
